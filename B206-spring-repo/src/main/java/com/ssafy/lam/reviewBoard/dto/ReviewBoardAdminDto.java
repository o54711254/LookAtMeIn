...
public class ReviewBoardAdminDto {
    ...
    private int reviewBoard_expected_price;
    private int reviewBoard_surgery_price;
    ...
    @Builder
    public ReviewBoardAdminDto(Long reviewBoard_seq, String reviewBoard_title, String reviewBoard_content, String customer_name, String reviewBoard_doctor, String reviewBoard_region, double score, String reviewBoard_hospital, int reviewBoard_expected_price, int reviewBoard_surgery_price, long regdate, boolean complain, boolean isdeleted) {
