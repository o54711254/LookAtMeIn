...
public class CommentDto {
    ...
    @Builder
    public CommentDto(Long freeboard_seq, Long user_seq, String customer_name, String customerId, String comment_content, Long comment_seq, LocalDateTime regdate) {
