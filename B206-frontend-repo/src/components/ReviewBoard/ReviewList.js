...
function ReviewList() {
  ...
  return (
    <div>
      ...
      <div className={styles.headtitle}><p>후기 게시판</p></div>
      <div className={styles.headtext}><p>룩앳미인에서 다양한 사람들의 후기를 확인하세요</p></div>
      </div>
      <div>
        {reviewBoardList.map((board) => (
          ...
          >
            <div><img src={profile} alt="프로필" className={styles.profile}/></div>
            ...
            <div className={styles.price}>시술가 : {board.reviewBoard_price} 원</div>
          </li>
        ))}
      </div>
    </div>
